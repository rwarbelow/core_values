...
p "Creating Options"
Option.create(option: "Strongly agree", value: 5)
Option.create(option: "Agree", value: 4)
Option.create(option: "Neutral", value: 3)
Option.create(option: "Disagree", value: 2)
Option.create(option: "Strongy disagree", value: 1)
